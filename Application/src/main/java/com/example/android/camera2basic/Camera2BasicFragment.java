...
public class Camera2BasicFragment extends Fragment
    ...
    private void writeToFile() {
        try {
            file = new File(getActivity().getExternalFilesDir(null), "test.txt");
    ...
    public void processFrame()
    {
        ...
        {
            for(int x=frame.getWidth();x>0;x--)
            {
                int colour = frame.getPixel(x, y);
                //Log.e(TAG, "true");
                if(colour>Color.BLACK&&colour<Color.DKGRAY)
                {
        ...
        //points = new float[arraylist.size()];
        //for(int i=0;i<arraylist.size();i++)
        //{
        //    points[i]=arraylist.get(i);
        //}

        arraylist.clear();
        //overlay.paintPoints(points);
        //overlay.paintBmp(bmp);
        //points = null;
    }
    ...
    public void setOverlay(GuideBox overlay)
    {
